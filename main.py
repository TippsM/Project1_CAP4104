...
def main():
    ...
    with consent:
        ...
        st.write("Please read the consent form below and confirm your agreements")

        st.markdown("""
        - I understand the purpose of this usability testing.
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            options=[" ", "Not Familiar", "Familiar", "Somewhat Familiar", "Very Familiar"])


            submitted = st.form_submit_button("Submit Demographics")
            if submitted:
                st.success("Demographics Data Saved! Thank you!")
    ...
    with exit:
        ...
        with st.form("exit_form"):
            ...
            satisfaction = st.select_slider("Overall Satisfaction (1: Very Low | 5: Very High)",
            options= [1, 2, 3, 4, 5])

            difficulty = st.select_slider("Overall Difficulty (1: Very Easy | 5: Very Hard)",
            options= [1, 2, 3, 4, 5])
